...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _openNewMatch() async {
    final result = await Navigator.of(context).push<MatchModel>(
      MaterialPageRoute(builder: (context) => const NewMatchSetupScreen()),
    );
    if (result != null && mounted) {
      ...
      Navigator.of(context)
          .push(
            MaterialPageRoute(builder: (context) => MatchScreen(match: result)),
          )
          .then((_) {
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFF0D3B2C), Color(0xFF1A5C42), Color(0xFF0D3B2C)],
          ),
        ),
        child: SafeArea(
          child: Column(
